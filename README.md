...
消融评测固定比较三种编排：仅 Planner、Planner + 独立 Reviewer、Planner + Reviewer + Time Check。当前离线结构负例的总体通过率分别为 33%、67%、100%，平均调用节点为 1.0、2.0、3.0；该结果用于量化硬约束节点的增益和成本，不代表线上真实 LLM 通过率。
