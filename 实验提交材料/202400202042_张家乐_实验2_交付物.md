...
清晰版架构图文件：[`202400202042_张家乐_实验2_架构图.png`](202400202042_张家乐_实验2_架构图.png)；SVG 可编辑源文件：[`202400202042_张家乐_实验2_架构图.svg`](202400202042_张家乐_实验2_架构图.svg)。

![TravelMind 实验二架构图](202400202042_张家乐_实验2_架构图.png)

图例：蓝色实线是 Supervisor 统一控制的结构化消息流；绿色实线是工具/RAG 数据流；灰色虚线是各 Agent 自己的私有记忆读写，虚线之间没有连接，表示不共享私有记忆。
...
详细设计文档：[`202400202042_张家乐_实验2_详细设计文档.md`](202400202042_张家乐_实验2_详细设计文档.md)。该文档包含 Agent 设计卡、任务流、消息字段、记忆隔离、失败路径和代码映射。
